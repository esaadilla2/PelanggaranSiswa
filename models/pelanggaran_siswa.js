...
module.exports = (sequelize, DataTypes) => {
  class pelanggaran_siswa extends Model {
    ...
    static associate(models) {
      // relasi: pelanggaran_siswa -> siswa, ini dari child ke parent
      ...
      // relasi: pelanggaran_siswa -> detail_pelanggaran_siswa, parent ke child
      ...
      this.hasMany(models.detail_pelanggaran_siswa, {
        ...
        as: "detail_pelanggaran_siswa" //as diisi dengan tujuan tabel
      })
    }
  }
